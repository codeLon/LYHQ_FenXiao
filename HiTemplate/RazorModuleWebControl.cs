    ...
    public class RazorModuleWebControl : WebControl
    {
        ...
        protected virtual void RenderModule(HtmlTextWriter writer, object jsonData)
        {
            ...
            if (string.IsNullOrEmpty(templateFileContent) || (templateFileContent.Length == 0))
            {
                ...
                //compliedTemplateFileContent = compliedTemplateFileContent.Replace("/Storage/", "http://wfx.ybwcfx.com/Storage/");
                writer.Write(System.Text.RegularExpressions.Regex.Replace(compliedTemplateFileContent, "<img[^>]*\\bsrc=('|\")([^'\">]*)\\1[^>]*>", "<img src='$2' data-echo='$2' />", System.Text.RegularExpressions.RegexOptions.IgnoreCase));
            ...
            else
            {
                ...
                //templateFileContent = templateFileContent.Replace("/Storage/", "http://wfx.ybwcfx.com/Storage/");
                //输出
                // writer.Write(templateFileContent);
                writer.Write(System.Text.RegularExpressions.Regex.Replace(templateFileContent, "<img[^>]*\\bsrc=('|\")([^'\">]*)\\1[^>]*>", "<img src='$2' data-echo='$2' />", System.Text.RegularExpressions.RegexOptions.IgnoreCase));
