...
using ManWee.TripDist.SIIS.API;
namespace Hidistro.UI.Web.API
{
    public class VshopProcess : IHttpHandler, IRequiresSessionState
    {
        ...
        private void setLogin(string Siis_UserId)
        {
            ...
            HttpContext.Current.Session["userid"] = Siis_UserId;
        ...
        public void UserLogin(HttpContext context)
        {
            ...
            if (!string.IsNullOrEmpty(str))
            {
                ...
                SIIS_OnLineUserClass online = new SIIS_OnLineUserClass();
                 var userValid=online.strGetLoginUserID(str, sourceData);
                if (userValid.Equals("00000000-0000-0000-0000-000000000000"))
                {
                    builder.Append("\"Status\":\"-1\"");
                    builder.Append("}");
                    context.Response.Write(builder.ToString());
